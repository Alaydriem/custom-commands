...
impl Config {
    pub async fn run<'a>(&'a self, _cfg: &Arc<Command>) {
        ...
        let bp_path = format!("{}/Packages/Microsoft.MinecraftUWP_8wekyb3d8bbwe/LocalState/games/com.mojang/development_behavior_packs/custom_commands", localappdata);
        let rp_path = format!("{}/Packages/Microsoft.MinecraftUWP_8wekyb3d8bbwe/LocalState/games/com.mojang/development_resource_packs/custom_commands", localappdata);
